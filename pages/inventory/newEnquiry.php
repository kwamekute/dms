          ...
          <section class="content">
                  ...
                  <form method="post" action="customer_add.php" enctype="multipart/form-data" class="form-horizontal">
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="date" class="">Supplier Name</label>
                        <div class="input-group col-sm-10">
                          <input type="text" class="form-control pull-right" id="date" name="supplier_name" placeholder="Enter Supplier Name" required>
                        </div><!-- /.input group -->
                      </div><!-- /.form group -->
                    </div>
                    ...
                    <div class="col-md-4">  
                      <div class="form-group">
                        <label for="date" class="">Supplier Address</label>
                        <div class="input-group col-md-10">
                          <input type="text" class="form-control pull-right" id="date" name="address" placeholder="Enter Supplier Address" required>
                        </div><!-- /.input group -->
                      </div><!-- /.form group -->
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <div class="input-group col-md-10">  
                          <input type="number" class="form-control pull-right" id="date" name="contact" placeholder="Contact Number" required>
                        </div>
                      </div>  
                    </div>
            ...
            <div class="col-md-4">
              <div class="box box-primary">
                ...
                <form method="post" action="enquiry_details.php" enctype="multipart/form-data">
