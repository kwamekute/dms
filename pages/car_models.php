...
<html>
  <head>
    ...
    <title>Car models | <?php include('../dist/includes/title.php');?></title>
...
<?php
		...
		$query=mysqli_query($con,"select * from model natural join manufact")or die(mysqli_error());
...
?>
				...
				<a href="#updateordinance<?php echo $row['model_id'];?>" data-target="#updateordinance<?php echo $row['model_id'];?>" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-edit text-blue"></i></a>
				
						</td>
                      </tr>
				<div id="updateordinance<?php echo $row['model_id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
...
<?php }?>					  
	  ...
	  <div class="col-md-3">
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <!-- Date range -->
                  <form method="post" action="add_car_model.php" enctype="multipart/form-data">
  
					  <div class="form-group">
						<label for="date">Car Model</label>
						<div class="input-group col-md-12">
						  <input type="text" class="form-control pull-right" id="date" name="model" placeholder="Enter Car Model" required>
						</div><!-- /.input group -->
					  </div><!-- /.form group -->
              ...
              $query2=mysqli_query($con,"select * from manufact")or die(mysqli_error());
                while($row2=mysqli_fetch_array($query2)){
                ?>
                  <option value="<?php echo $row2['manufact_id'];?>"><?php echo $row2['manufact_name'];?></option>
                  <?php echo $row2['manufact_id'];?>
                ...
                <?php }?>
					  ...
					  <div class="form-group">
						<div class="input-group">
						  <button class="btn btn-primary" id="daterange-btn" name="submit">
							Add
						  </button>
