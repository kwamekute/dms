        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header" style="padding-left:20px">
              <a href="<?php echo URLROOT;?>/pages/home.php" class="navbar-brand"><b><i class="glyphicon glyphicon-home"></i> <?php echo $branch_name;?> </b></a>
              ...
              <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
				  ...
				  <li class="">
                    ...
                    <a href="<?php echo URLROOT;?>/pages/log.php" class="dropdown-toggle">
                  ...
                  <li class="dropdown notifications-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <?php 
                      $query=mysqli_query($con,"select COUNT(*) as count from parts where part_qty<=reorder and branch_id='$branch'")or die(mysqli_error());
                			$row=mysqli_fetch_array($query);
                			echo $row['count'];
                			?>	
                      </span>
                    ...
                    <ul class="dropdown-menu">
                      <li class="header">You have <?php echo$row['count'];?> parts that needs reorder</li>
                      <li>
                        <!-- Inner Menu: contains the notifications -->
                        <ul class="menu">
                        <?php
                        $queryprod=mysqli_query($con,"select part_name from parts where part_qty<=reorder and branch_id='$branch'")or die(mysqli_error());
			  while($rowprod=mysqli_fetch_array($queryprod)){
			?>
                          <li><!-- start notification -->
                            <a href="reorder.php">
                              <i class="glyphicon glyphicon-refresh text-red"></i> <?php echo $rowprod['part_name'];?>
                            </a>
                          </li><!-- end notification -->
                          <?php }?>
                        </ul>
				   ...
				   <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        ...
                        <ul class="menu">
						  <li><!-- start notification -->
                            <a href="<?php echo URLROOT;?>/pages/category.php">
						  ...
						  <li><!-- start notification -->
                            <a href="<?php echo URLROOT;?>/pages/parts.php">
                              <i class="glyphicon glyphicon-cutlery text-green"></i> Parts
                            </a>
                          </li><!-- end notification -->
                          ...
                          <li>
                          <a href="<?php echo URLROOT;?>/pages/car_models.php">
                              <i class="glyphicon glyphicon-send text-green"></i> Car Models
                            </a>
                          </li>
